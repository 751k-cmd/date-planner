...
with st.expander("⚙️ こだわり設定（詳細）", expanded=False): # expanded=Falseに変更
    ...
    include_conv = st.checkbox("会話ネタも提案してほしい", value=False)
